...
class PetTypeMapper {
    ...
    fun toPetTypeFieldsDto(petType: PetType): PetTypeFieldsDto =
        PetTypeFieldsDto().apply {
            name = petType.name
        }

    fun toPetTypeDtos(petTypes: Collection<PetType>): List<PetTypeDto> = petTypes.map { toPetTypeDto(it) }
}
