...
class UserMapper {
    ...
    fun toRoleDtos(roles: Collection<Role>): Collection<RoleDto> = roles.map { toRoleDto(it) }
    ...
    fun toRoles(roleDtos: Collection<RoleDto>): Collection<Role> = roleDtos.map { toRole(it) }
}
